...
def get_args():
    ...
    parser.add_argument("-ref", required = True, help = "Путь к файлу-образцу")
    parser.add_argument("-c", required = True, help = "Путь к файлу, что будет сравниваться с образцом")
    return parser.parse_args()

if __name__ == '__main__':
    args = vars(get_args())
    print(get_ssim(args['ref'], args['c']))